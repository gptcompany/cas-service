...
- `docs/milestones/MS-X-advanced-cas-compute-gsd.md`
...
1. Open `docs/milestones/MS-X-advanced-cas-compute-gsd.md`
...
```text
Resume milestone MS-X from checkpoint <LAST_CHECKPOINT> using docs/milestones/MS-X-advanced-cas-compute-gsd.md.
...
Milestone doc: docs/milestones/MS-X-advanced-cas-compute-gsd.md
